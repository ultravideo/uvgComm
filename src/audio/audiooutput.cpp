...
void AudioOutput::initializeAudio(QAudioFormat format)
{
  ...
  if (!info.isFormatSupported(format)) {
    printDebugObject(DEBUG_WARNING, this, "Iniating", "Default format not supported - trying to use nearest.");
...
{
  printDebugObject(DEBUG_WARNING, this, "Audio", "Audio output device change not implemented fully.",
